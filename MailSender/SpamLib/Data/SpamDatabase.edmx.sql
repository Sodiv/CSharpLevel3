...
-- --------------------------------------------------
-- Date Created: 11/13/2018 20:56:59
-- Generated from EDMX file: E:\CSharpLevel3\MailSender\SpamLib\Data\SpamDatabase.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[dbo].[FK_MailingListScheduleTask]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[ScheduleTasks] DROP CONSTRAINT [FK_MailingListScheduleTask];
GO
...
-- Creating primary key on [Emails_Id], [ScheduleTasks_Id] in table 'EmailScheduleTask'
ALTER TABLE [dbo].[EmailScheduleTask]
ADD CONSTRAINT [PK_EmailScheduleTask]
    PRIMARY KEY CLUSTERED ([Emails_Id], [ScheduleTasks_Id] ASC);
GO
...
-- Creating foreign key on [ScheduleTasks_Id] in table 'EmailScheduleTask'
ALTER TABLE [dbo].[EmailScheduleTask]
ADD CONSTRAINT [FK_EmailScheduleTask_ScheduleTask]
    FOREIGN KEY ([ScheduleTasks_Id])
...
ALTER TABLE [dbo].[ScheduleTasks]
ADD CONSTRAINT [FK_MailingListScheduleTask]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_MailingListScheduleTask'
CREATE INDEX [IX_FK_MailingListScheduleTask]
ON [dbo].[ScheduleTasks]
    ([MailingList_Id]);
GO
